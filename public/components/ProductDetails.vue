...
<html lang="es">
  ...
  <body class="text-black-50">
    <main>
        ...
        <div class="container pb-2 pt-2">
          <div class="gx-lg-5 gy-4 row">
            <div class="col-lg-7 col-xl-8"> 
              <h2 class="h5 mb-3 text-dark">Acerca de Salón Diamante</h2>
              ...
              <hr class="mb-4 mt-4"/>
              <h2 class="h5 mb-3 text-dark">Destacados</h2>
              <div class="gy-2 row row-cols-2 row-cols-md-3 row-cols-xl-4 small text-secondary">
                <div> 
                  ...
                  <span class="align-middle">+300 invitados</span> 
                </div>
                <div> 
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1rem" height="1rem" class="me-2 text-primary" fill="currentColor">
                    <path fill="none" d="M0 0h24v24H0z"/>
                  ...
                  <span class="align-middle">Wi-Fi gratis</span> 
                </div>
                <div> 
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1rem" height="1rem" class="me-2 text-primary" fill="currentColor">
                    <path fill="none" d="M0 0h24v24H0z"/>
                  ...
                  <span class="align-middle">Valet parking</span> 
                </div>
                <div> 
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1rem" height="1rem" class="me-2 text-primary" fill="currentColor">
                    <path fill="none" d="M0 0h24v24H0z"/>
                  ...
                  <span class="align-middle">8 baños (4 + 4)</span> 
                </div>
                <div> 
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1rem" height="1rem" class="me-2 text-primary" fill="currentColor">
                    <path fill="none" d="M0 0h24v24H0z"/>
                  ...
                  <span class="align-middle">Amplios jardines</span> 
                </div>
                <div> 
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1rem" height="1rem" class="me-2 text-primary" fill="currentColor">
                    <path fill="none" d="M0 0h24v24H0z"/>
                  ...
                  <span class="align-middle">Espacios infantiles</span> 
                </div>
                <div> 
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1rem" height="1rem" class="me-2 text-primary" fill="currentColor">
                    <path fill="none" d="M0 0h24v24H0z"/>
                  ...
                  <span class="align-middle">Climatización</span> 
                </div>
                <div> 
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1rem" height="1rem" class="me-2 text-primary" fill="currentColor">
                    <path fill="none" d="M0 0h24v24H0z"/>
                  ...
                  <span class="align-middle">Bar</span> 
                </div>
                <div> 
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1rem" height="1rem" class="me-2 text-primary" fill="currentColor">
                    <path fill="none" d="M0 0h24v24H0z"/>
                  ...
                  <span class="align-middle">3 escenarios</span> 
                </div>
                <div> 
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1rem" height="1rem" class="me-2 text-primary" fill="currentColor">
                    <path fill="none" d="M0 0h24v24H0z"/>
                  ...
                  <span class="align-middle">Guardería</span> 
                </div>
                
              </div>
              <hr class="mb-4 mt-4"/>
              <h2 class="h5 mb-3 text-dark">Imágenes</h2>
              <div id="carouselproveedor">
                  <CarouselProveedor :arrows="false" :dots="true"></CarouselProveedor>
              </div>
              <hr class="mb-4 mt-4"/>
              <h2 class="h5 mb-3 text-dark">3 Reseñas</h2>
              <div class="gy-2 row">
                ...
                <div class="col-md">
                  <div class="align-items-center gy-2 mb-2 row">
                    <div class="col-sm">
                      <h3 class="h5 text-dark">Jesús Abraham Caballero</h3>
                    ...
                    <div class="col-sm-auto"> 
                      <span class="text-secondary">17 March, 2021</span> 
                    </div>
                  </div>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p> 
                </div>
              ...
              <div class="gy-2 row">
                ...
                <div class="col-md">
                  <div class="align-items-center gy-2 mb-2 row">
                    <div class="col-sm">
                      <h3 class="h5 text-dark">José Luis Nájera</h3>
                      <span class="d-inline-flex text-primary"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1.125em" height="1.125em">
                          <g>
                            <path fill="none" d="M0 0h24v24H0z"/>
                            <path d="M12 18.26l-7.053 3.948 1.575-7.928L.587 8.792l8.027-.952L12 .5l3.386 7.34 8.027.952-5.935 5.488 1.575 7.928z"/>
              ...
              <div class="gy-2 row">
                ...
                <div class="col-md">
                  <div class="align-items-center gy-2 mb-2 row">
                    <div class="col-sm">
                      <h3 class="h5 text-dark">José Pérez</h3>
                      <span class="d-inline-flex text-primary"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1.125em" height="1.125em">
                          <g>
                            <path fill="none" d="M0 0h24v24H0z"/>
                            <path d="M12 18.26l-7.053 3.948 1.575-7.928L.587 8.792l8.027-.952L12 .5l3.386 7.34 8.027.952-5.935 5.488 1.575 7.928z"/>
              ...
              <div class="gy-3 gy-lg-3 gy-md-4 row row-cols-lg-1 row-cols-md-2">
                ...
                <div>
                  <div class="bg-light h-100 p-4">
                    <h2 class="h5 text-dark">Información</h2>
                    <hr/>
                    <div class="mb-3">
                      <div class="g-0 mb-2 row">
                        ...
                        <div class="col">Huasca de Ocampo, Hidalgo.                             
</div>
                      </div>
                      <div class="g-0 mb-2 row">
                        <div class="col-auto">
                        ...
                        <div class="col"> 
                          <a href="#" class="link-secondary text-decoration-none">Consultar</a> 
                        </div>
                      </div>
                      <div class="g-0 mb-2 row">
                        <div class="col-auto">
                        ...
                        <div class="col"> 
                          <a href="tel:+0 123-456-789" class="link-secondary text-decoration-none">Chat</a> 
                        </div>
                      </div>
                      <div class="g-0 mb-2 row">
                        <div class="col-auto">
                        ...
                        <div class="col"> 
                          <a href="#" class="link-secondary text-decoration-none">https://tupachanga.mx/SalonDiamante</a> 
                        </div>
                      </div>
                    </div>
                ...
                <div>
                  <div class="bg-light h-100 p-4">
                    <h2 class="h5 text-dark">Calendario</h2>
                    <VCalendar></VCalendar>
                    </div>
                ...
                <div class="col-md-12">
                  <div class="bg-light h-100 p-4">
                    <h2 class="h5 text-dark">Tu valoración</h2>
                    <hr/>
                    <form> 
                      <div class="mb-3"> 
                        <input type="text" class="form-control p-3" id="inputSubject" placeholder="Título" required> 
                      </div>
                      <div class="mb-3"> 
                        <textarea class="form-control p-3" rows="6" id="inputTextarea" placeholder="Opinión" required></textarea> 
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="form-check mb-4">
                        ...
                        <label class="form-check-label" for="exampleCheck1">Acepto las condiciones de sitio respecto a las opiniones y, en especial, el hecho de que sean públicadas aun si mi usuario no aparece como autor.</label>
                      </div>                       
      ...
      <section class="pb-5 pt-5" data-pgc="directory.related_listings">
        <div class="container">
          <div class="align-items-center row">
            <div class="col-md"> 
              <h2 class="text-dark">Relacionados</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit eiusmod</p> 
            </div>
            <div class="col-md-auto"> 
              <a class="btn btn-primary pe-4 ps-4 rounded-pill" href="#">View More</a> 
            </div>
          </div>
          <div class="justify-content-center row"> 
            <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
              <div class="border"> 
                <a href="#" class="d-block"><img src="https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDY5fHxhbyUyMG5hbmd8ZW58MHx8fA&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=350&h=240&fit=crop" class="img-fluid w-100" alt="Location image" width="350" height="240"></a>
            ...
            <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
              <div class="border"> 
                <a href="#" class="d-block"><img src="https://images.unsplash.com/photo-1596178065887-1198b6148b2b?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDkxfHxjaGljYWdvJTIwaG90ZWx8ZW58MHx8fA&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=350&h=240&fit=crop" class="img-fluid w-100" alt="Location image" width="350" height="240"></a>
                <div class="pb-3 ps-4 pe-4 pt-4">
                  <div class="align-items-center d-flex justify-content-between">
                    <div class="pb-1 pt-1">
            ...
            <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
              <div class="border"> 
                <a href="#" class="d-block"><img src="https://images.unsplash.com/photo-1548588627-f978862b85e1?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDY5fHxhbm5hcHVybmElMjBiYXNlJTIwY2FtcHxlbnwwfHx8&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=350&h=240&fit=crop" class="img-fluid w-100" alt="Location image" width="350" height="240"></a>
                <div class="pb-3 ps-4 pe-4 pt-4">
                  <div class="align-items-center d-flex justify-content-between">
                    <div class="pb-1 pt-1">
            ...
            <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
              <div class="border"> 
                <a href="#" class="d-block"><img src="https://images.unsplash.com/photo-1569369926169-9ee7fb80adeb?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDMwfHxldmVyZXN0JTIwaG90ZWx8ZW58MHx8fA&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=350&h=240&fit=crop" class="img-fluid w-100" alt="Location image" width="350" height="240"></a>
                <div class="pb-3 ps-4 pe-4 pt-4">
                  <div class="align-items-center d-flex justify-content-between">
                    <div class="pb-1 pt-1">
      ...
      <section class="bg-primary py-4 text-white" data-pgc="directory.cta" data-pgc-field="CTA_Classes"> 
        <div class="container py-3"> 
          <div class="align-items-center row"> 
            <div class="col-lg-7"> 
              <h2 class="mb-3">Regístrate e incluye tus productos o sercicios</h2>
            ...
            <div class="col-lg-auto ms-auto"> 
                <b-button id="show-btn" variant="primary" class="btn btn-outline-light ps-4 pe-4 rounded-pill"  @click="showRegistrationModal">Registrarse</b-button>
                    <b-modal ref="registration-modal"  centered ok-only ok-variant="danger" ok-title="Cancelar" title="Registro de usuario">
                    <div class="d-block text-center">
                        <img src="assets/images/Logo_tu_pachanga_C.png" height="90">
                        <h3>¿Cómo desea registrarse?</h3>                        
                    </div>
                    
                    <div class="text-center mt-5">
                        <b-button variant="primary" @click="hideRegistrationModal">Cliente o consumidor</b-button>
                        <b-button variant="primary" @click="toggleRegistrationModal">Proveedor</b-button>
                    </div>
                    </b-modal>
  ...
  export default {
    methods: {
      ...
      toggleRegistrationModal() {
        ...
        this.$refs['registration-modal'].toggle('#toggle-btn')
      },
      showLoginModal() {
