<template>
  <form-wizard @onComplete="onComplete">
    <tab-content title="Tus datos" :selected="true">
      <div class="form-group">
        ...
        <div v-if="hasError('fullName')" class="invalid-feedback">
          <div class="error" v-if="!$v.formData.fullName.required">Proporcione un nombre.</div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div v-if="hasError('email')" class="invalid-feedback">
          <div class="error" v-if="!$v.formData.email.required">Proporcione una dirección de correo</div>
          <div class="error" v-if="!$v.formData.email.email">Debe corresponder a una dirección de correo electrónico</div>
        </div>
      </div>
    </tab-content>
